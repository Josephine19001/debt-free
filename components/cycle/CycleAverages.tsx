      ...
      <View className="px-4 mb-6">
        <View className={`${isDark ? 'bg-gray-900 border-pink-700' : 'bg-white border-gray-100'} rounded-2xl p-4 border`}>
          <View className="flex-row items-center mb-4">
            <View className={`w-10 h-10 rounded-2xl ${isDark ? 'bg-pink-900' : 'bg-blue-100'} items-center justify-center mr-3`}>
              <TrendingUp size={20} color={isDark ? '#EC4899' : '#3B82F6'} />
            </View>
            <Text className={`text-lg font-semibold ${isDark ? 'text-gray-100' : 'text-black'}`}>Cycle Averages</Text>
          </View>
  ...
  return (
    <View className="px-4 mb-6">
      ...
      <View className="flex-row gap-3">
        ...
        <View
          className={`flex-1 ${isDark ? 'bg-gray-900 border-pink-700' : 'bg-white border-gray-100'} rounded-2xl p-4 border`}
          style={{
        ...
        >
          <View className="items-center">
            <View className={`w-10 h-10 rounded-full ${isDark ? 'bg-pink-800' : 'bg-blue-100'} items-center justify-center mb-3`}>
              <Calendar size={18} color={isDark ? '#EC4899' : '#3B82F6'} />
            </View>
            <Text className={`text-2xl font-bold ${isDark ? 'text-gray-100' : 'text-gray-900'} mb-1`}>
        ...
        >
          <View className="items-center">
            <View className={`w-10 h-10 rounded-full ${isDark ? 'bg-pink-800' : 'bg-red-100'} items-center justify-center mb-3`}>
